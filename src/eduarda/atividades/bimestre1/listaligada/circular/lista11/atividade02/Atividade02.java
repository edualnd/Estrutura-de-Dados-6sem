package eduarda.atividades.bimestre1.listaligada.circular.lista11.atividade02;
...
public class Atividade02 {
    ...
    static void main() {
        ...
        exibir();
        System.out.print("O centro é: ");
        centro();
    }

    private static void centro() {
        No pri = inicio;
        No ult = fim;
        ...
        else System.out.println((pri.getValor()+ ult.getValor())/2.0);
